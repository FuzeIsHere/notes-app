  ...
  return (
    <div style={styles.pageWrapper(currentTheme)}>
      ...
      <div style={styles.authCard(currentTheme)}>
        ...
        <p style={styles.subtitle}>Sign in to resume tracking your markdown thoughts.</p>
        ...
        <div style={styles.footerLinkContainer}>
          <span style={styles.footerText}>New to CoNotate? </span>
          <button onClick={() => navigate('/signup')} style={styles.inlineLinkBtn}>
            Create an account
          </button>
        </div>
      </div>
